...
app.post("/submit", (req, res) => {
  var randomNoun = Math.floor(Math.random()*nounLength);

var randomAdj = Math.floor(Math.random()*adjLength);



var randomBandName = adj[randomAdj] + " " + noun[randomNoun];

  
 const bandName = randomBandName;
 res.render("index.ejs", {bandss: bandName});
